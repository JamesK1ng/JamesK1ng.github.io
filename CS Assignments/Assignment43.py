...
def getData():
     ...
     df = input("Enter CSV file name:") #<-- placeholder, can remove once defined.
...
def getColumnNames():
     ...
     lonName = input("Enter Clumn name for longitude:")#<-- placeholder, can remove once defined.
...
def getLocale():
     ...
     lon = input("Enter current longitude:")      #<-- placeholder, can remove once defined.
...
def computeDist(x1,y1,x2,y2):
     ...
     """
     d = (x1-x2)**2 + (y1-y2)**2  #<-- placeholder, can remove once defined.
